...
describe('Create ELSP - review existing challenges page', () => {
  beforeEach(() => {
    jest.resetAllMocks()
  })

  it('should render the Review Challenges page', () => {
    // Given
    const params = {
      ...templateParams,
      groupedChallenges: Result.fulfilled({
  ...
  it('should render the Review Challenges page given prisoner has no Challenges', () => {
    // Given
    const params = {
      ...templateParams,
      groupedChallenges: Result.fulfilled({}),
  ...
  it('should render the Review Challenges page given the Challenges service API promise is not resolved', () => {
    // Given
    const params = {
      ...templateParams,
