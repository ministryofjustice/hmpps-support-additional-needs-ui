...
describe('selectCategorySchema', () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks()
    req.originalUrl = '/strengths/A1234BC/create/61375886-8ec3-4ed4-a017-a0525817f14a/select-category'
  })
  ...
  it.each([
    ...
    expect(res.redirectWithErrors).toHaveBeenCalledWith(
      '/strengths/A1234BC/create/61375886-8ec3-4ed4-a017-a0525817f14a/select-category',
      expectedErrors,
    )
  })
})
