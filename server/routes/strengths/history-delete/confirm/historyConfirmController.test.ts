...
describe('history-delete/confirm/historyConfirmController', () => {
  ...
  const controller = new HistoryConfirmController(strengthService, auditService)
  ...
  describe('submitConfirmForm', () => {
    it('should delete history strength, fire audit with mode: history, clear journey data, and redirect with success', async () => {
      // Given
