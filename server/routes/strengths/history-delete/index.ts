...
const historyDeleteStrengthRoutes = (services: Services): Router => {
  ...
  const reasonController = new HistoryReasonController(strengthService)
  const reviewController = new HistoryReviewController(strengthService)
  const confirmController = new HistoryConfirmController(strengthService, auditService)
...
export default historyDeleteStrengthRoutes
