...
describe('deleteReasonSchema', () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks()
    req.originalUrl =
      '/challenges/A1234BC/187168d1-121c-42bf-b456-47711924ffa4/delete/473e9ee4-37d6-4afb-92a2-5729b10cc60f/reason'
  })
    ...
    it.each([null, undefined, ''])(
      ...
      async deleteReason => {
        ...
        const expectedErrors: Array<Error> = [
          {
            href: '#deleteReason',
            text: 'Add reason for deleting challenge',
          },
        ]
  ...
  describe('mode: history', () => {
    it('sad path - deleteReason missing returns history error message', async () => {
      ...
      const expectedErrors: Array<Error> = [
        {
          href: '#deleteReason',
          text: 'Add reason for deleting history challenge',
        },
      ]
