...
export default class LearningEnvironmentAdjustmentsController {
  getLearningEnvironmentAdjustmentsView: RequestHandler = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const learningEnvironmentAdjustments = invalidForm ?? undefined // TODO - populate form from the DTO in journeyData

    const viewRenderArgs = { prisonerSummary, form: learningEnvironmentAdjustments }
