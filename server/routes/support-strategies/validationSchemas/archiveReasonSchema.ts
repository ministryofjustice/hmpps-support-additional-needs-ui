...
const archiveReasonSchema = async () => {
  ...
  const archiveReasonMandatoryMessage = 'Add reason for moving this support strategy to the History'
  const archiveReasonMaxLengthMessage = `Reason for moving this support strategy to the History must be ${ARCHIVE_REASON_MAX_LENGTH} characters or less`
