...
const editConditionsRoutes = (services: Services): Router => {
  ...
  router.use('/', [
    ...
    insertJourneyIdentifier({ insertIdAfterElement: 4 }), // insert journey ID immediately after '/conditions/:prisonNumber/:conditionsReference/edit/details' - eg: '/conditions/A1234BC/187168d1-121c-42bf-b456-47711924ffa4/edit/473e9ee4-37d6-4afb-92a2-5729b10cc60f/details'
  ])
