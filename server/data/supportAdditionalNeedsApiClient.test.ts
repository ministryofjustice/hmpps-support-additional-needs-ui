...
describe('supportAdditionalNeedsApiClient', () => {
  ...
  describe('deleteChallenge', () => {
    it('should delete a prisoners challenge via query string params with no request body', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient.deleteChallenge(
        prisonNumber,
        challengeReference,
        username,
        deletePrisonId,
    ...
    it('should rethrow error given API returns an error', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient
        .deleteChallenge(prisonNumber, challengeReference, username, deletePrisonId, deleteReason)
        .catch(e => e)
  ...
  describe('deleteCondition', () => {
    it('should delete a prisoners condition via query string params with no request body', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient.deleteCondition(
        prisonNumber,
        conditionReference,
        username,
        deletePrisonId,
    ...
    it('should rethrow error given API returns an error', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient
        .deleteCondition(prisonNumber, conditionReference, username, deletePrisonId, deleteReason)
        .catch(e => e)
  ...
  describe('deleteSupportStrategy', () => {
    it('should delete a prisoners support strategy via query string params with no request body', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient.deleteSupportStrategy(
        prisonNumber,
        supportStrategyReference,
        username,
        deletePrisonId,
    ...
    it('should rethrow error given API returns an error', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient
        .deleteSupportStrategy(prisonNumber, supportStrategyReference, username, deletePrisonId, deleteReason)
        .catch(e => e)
  ...
  describe('deleteAdditionalLearningNeedsScreener', () => {
    it('should delete the latest ALN Screener via query string params with no request body', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient.deleteAdditionalLearningNeedsScreener(
        prisonNumber,
        username,
        deletePrisonId,
        deleteReason,
    ...
    it('should rethrow error given API returns an error', async () => {
      ...
      // When
      const actual = await supportAdditionalNeedsApiClient
        .deleteAdditionalLearningNeedsScreener(prisonNumber, username, deletePrisonId, deleteReason)
        .catch(e => e)
