...
/**
 * Hardcoded challenges reference data in the exact same order the API currently returns.
 * This decouples the UI from the API for what is fundamentally a presentation concern.
 */
const challengesReferenceData: ReferenceDataListResponse = {
  referenceDataList: [
    ...
    // Attention, Organising & Time Management
    {
      code: 'FOCUSING',
