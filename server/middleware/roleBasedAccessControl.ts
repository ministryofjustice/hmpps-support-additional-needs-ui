...
const rolesForAction = (): Record<ApplicationAction, Array<DpsRole>> => ({
  ...
  [ApplicationAction.DELETE_CHALLENGES]: [DpsRole.ROLE_SAN_EDITOR, DpsRole.ROLE_SAN_EDUCATION_MANAGER],
  ...
  [ApplicationAction.DELETE_SUPPORT_STRATEGIES]: [DpsRole.ROLE_SAN_EDITOR, DpsRole.ROLE_SAN_EDUCATION_MANAGER],
