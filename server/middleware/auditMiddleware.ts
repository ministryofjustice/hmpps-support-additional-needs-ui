...
const pageViewEventMap: Record<string, Page> = {
  ...
  // Delete history strengths routes
  '/strengths/:prisonNumber/:strengthReference/history-delete/:journeyId/reason': Page.DELETE_HISTORY_STRENGTH_REASON,
  '/strengths/:prisonNumber/:strengthReference/history-delete/:journeyId/review': Page.DELETE_HISTORY_STRENGTH_REVIEW,
  '/strengths/:prisonNumber/:strengthReference/history-delete/:journeyId/confirm': Page.DELETE_HISTORY_STRENGTH_CONFIRM,
  ...
  // Delete challenges routes
  '/challenges/:prisonNumber/:challengeReference/delete/:journeyId/reason': Page.DELETE_CHALLENGE_REASON,
  ...
  // Delete ALN Screener routes
  '/aln-screener/:prisonNumber/delete/:journeyId/reason': Page.DELETE_ALN_SCREENER_REASON,
  '/aln-screener/:prisonNumber/delete/:journeyId/review': Page.DELETE_ALN_SCREENER_REVIEW,
  '/aln-screener/:prisonNumber/delete/:journeyId/confirm': Page.DELETE_ALN_SCREENER_CONFIRM,
  ...
  '/strengths/:prisonNumber/:strengthReference/history-delete/reason': null,
  '/strengths/:prisonNumber/:strengthReference/history-delete/review': null,
  '/strengths/:prisonNumber/:strengthReference/history-delete/confirm': null,
  ...
  '/aln-screener/:prisonNumber/delete/reason': null,
  '/aln-screener/:prisonNumber/delete/review': null,
  '/aln-screener/:prisonNumber/delete/confirm': null,
