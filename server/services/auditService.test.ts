...
describe('Audit service', () => {
  ...
  describe('logArchiveChallenge', () => {
    it('should send Archive Challenge event audit message', async () => {
      // Given
      ...
      // When
      const actual = await auditService.logArchiveChallenge(baseArchiveAuditData)

      // Then
      expect(actual).toEqual(expectedSqsMessageResponse)
      expect(hmppsAuditClient.sendMessage).toHaveBeenCalledWith(
        {
          what: 'ARCHIVE_CHALLENGE',
          correlationId: '49380145-d73d-4ad2-8460-f26b039249cc',
          details: { challengeReference: '94429db1-c063-459e-8479-8fe2440dbfbd' },
          subjectId: 'A1234BC',
          subjectType: 'PRISONER_ID',
  ...
  describe('logArchiveStrength', () => {
    it('should send Archive Strength event audit message', async () => {
      // Given
      ...
      // When
      const actual = await auditService.logArchiveStrength(baseArchiveAuditData)

      // Then
      expect(actual).toEqual(expectedSqsMessageResponse)
      expect(hmppsAuditClient.sendMessage).toHaveBeenCalledWith(
        {
          what: 'ARCHIVE_STRENGTH',
          correlationId: '49380145-d73d-4ad2-8460-f26b039249cc',
          details: { strengthReference: '94429db1-c063-459e-8479-8fe2440dbfbd' },
          subjectId: 'A1234BC',
          subjectType: 'PRISONER_ID',
  ...
  describe('logEditCondition', () => {
    it('should send Edit Condition event audit message', async () => {
      // Given

      const baseArchiveAuditData: BaseAuditData = {
        correlationId: '49380145-d73d-4ad2-8460-f26b039249cc',
        details: { conditionReference: '94429db1-c063-459e-8479-8fe2440dbfbd' },
        subjectId: 'A1234BC',
        subjectType: 'PRISONER_ID',
        who: 'a-dps-user',
      }
      ...
      // When
      const actual = await auditService.logEditCondition(baseArchiveAuditData)
  ...
  describe('logArchiveCondition', () => {
    it('should send Archive Condition event audit message', async () => {
      // Given
      ...
      // When
      const actual = await auditService.logArchiveCondition(baseArchiveAuditData)

      // Then
      expect(actual).toEqual(expectedSqsMessageResponse)
      expect(hmppsAuditClient.sendMessage).toHaveBeenCalledWith(
        {
          what: 'ARCHIVE_CONDITION',
          correlationId: '49380145-d73d-4ad2-8460-f26b039249cc',
          details: { conditionReference: '94429db1-c063-459e-8479-8fe2440dbfbd' },
          subjectId: 'A1234BC',
          subjectType: 'PRISONER_ID',
  ...
  describe('logArchiveSupportStrategy', () => {
    it('should send Archive Support Strategy event audit message', async () => {
      // Given
      ...
      // When
      const actual = await auditService.logArchiveSupportStrategy(baseArchiveAuditData)

      // Then
      expect(actual).toEqual(expectedSqsMessageResponse)
      expect(hmppsAuditClient.sendMessage).toHaveBeenCalledWith(
        {
          what: 'ARCHIVE_SUPPORT_STRATEGY',
          correlationId: '49380145-d73d-4ad2-8460-f26b039249cc',
          details: { supportStrategyReference: '94429db1-c063-459e-8479-8fe2440dbfbd' },
          subjectId: 'A1234BC',
          subjectType: 'PRISONER_ID',
